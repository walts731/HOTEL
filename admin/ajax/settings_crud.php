<?php
    ...
    if(isset($_POST['get_general'])){
        $q = "SELECT * FROM `settings` WHERE `settings_id`=?";
        $values = [1];
    ...
    if(isset($_POST['upd_general'])){
        ...
        $q = "UPDATE `settings` SET `site_title`=?,`site_about`=? WHERE `settings_id`=?";
    ...
    if(isset($_POST['upd_shutdown'])){
        ...
        $q = "UPDATE `settings` SET `shutdown`=? WHERE `settings_id`=?";
        $values = [$frm_data,1];
    ...
    if(isset($_POST['upd_contacts'])){
        ...
        $q = "UPDATE `settings` SET `address`=?,`gmap`=?,`pn1`=?,`pn2`=?,`email`=?,`fb`=?,`insta`=?,`tw`=?,`iframe`=? WHERE `sr_no`=?";
